...
\lstinputlisting[label=Extrait du rapport de CPN,
  caption=Extrait du rapport de CPN,
  firstline=24,lastline=27]{Report.txt}
...
\lstinputlisting[label=marquages,caption=Liste des marquages accessibles du Réseau de Pétre de l'exercice 1.3,breaklines=true]{Ex_1_3_state_space.txt}
