...
produit cartésien du domaine des couleurs des SECTION avec le domaine de couleurs VOITURES d'une liste de jetons la couleur 
VOITURE.
\begin{flalign}
&Clr(p_1) = \{SECTION, VOITURES\}\quad avec\quad\{1..N-1\} x \{[VOITURES]_1, [VOITURES]_2,...,[VOITURES]_M\}& \\
&M_0 = \begin{pmatrix} 
